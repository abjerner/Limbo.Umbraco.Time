angular.module("umbraco.directives").directive("limboTimeWeekdays", function () {
    return {
        scope: {
            value: "=",
            config: "="
        ...
        restrict: "E",
        replace: true,
        templateUrl: "/App_Plugins/Limbo.Umbraco.Time/Views/Directives/Weekdays.html",
        link: function (scope) {
            ...
            function initModel() {
                ...
                // If we reach this point, it means that the model is either valid or hasn't yet been initialize (eg. when creating a new content item)
                scope.value = { 0: initDay(), 1: initDay(), 2: initDay(), 3: initDay(), 4: initDay(), 5: initDay(), 6: initDay() };
